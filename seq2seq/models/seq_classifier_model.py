...
class SeqClassifierModel(ModelBase):
    """Base class for seq_classifier models with embeddings
    """

    def __init__(self, params, mode, name):
        super(SeqClassifierModel, self).__init__(params, mode, name)
    ...
    def _clip_gradients(self, grads_and_vars):
        ...
        grads_and_vars = super(SeqClassifierModel, self)._clip_gradients(grads_and_vars)
    ...
    def _preprocess(self, features, labels):
        ...
        num_tokens = tf.reduce_sum(labels["source_len"])
    ...
    # need to be update seq2seq loss
