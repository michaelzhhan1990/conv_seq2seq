...
from seq2seq.models.seq_classifier_model import SeqClassifierModel
from seq2seq.graph_utils import templatemethod
from seq2seq.models import bridges
from seq2seq.inference import beam_search


class ConvSeqClassifier(SeqClassifierModel):
    ...
    def __init__(self, params, mode, name="conv_seq2seq"):
        print('init conv_seqclassifier class\n\n\n\n')
        super(ConvSeqClassifier, self).__init__(params, mode, name)
    ...
    @staticmethod
    def default_params():
        params = SeqClassifierModel.default_params().copy()
        params.update({
    ...
    def encode(self, features, labels):
        ...
        features["source_ids"] = tf.reverse_sequence(features["source_ids"], features["source_len"], batch_dim=0,
                                                     seq_dim=1)  # [[1,2,3,4,PAD,PAD,PAD],[2,3,PAD,PAD,PAD,PAD,PAD]]   [4,2]
        features["source_ids"] = tf.reverse(features["source_ids"], [
